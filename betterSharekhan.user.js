...
function createPositionsDropdown() {
    ...
    selectBox.addEventListener("change", function() {
        ...
        jQ("#sort > tbody > tr:nth-child(5) > td:nth-child(16)").append(`<span id='idtodaymtm'><br /><b style="background: pink;">${tdymtm}</b></span>`);

        jQ('#idsettledmtm').remove();
        jQ("#sort > tbody > tr:nth-child(5) > td:nth-child(17)").append(`<span id='idsettledmtm'><br /><b style="background: pink;">${settledmtm}</b></span>`);

        jQ('#idtotalmtm').remove();
        jQ("#sort > tbody > tr:nth-child(5) > td:nth-child(18)").append(`<span id='idtotalmtm'><br /><b style="background: pink;">${totalmtm}</b></span>`);

        jQ('#idtdybpl').remove();
        jQ("#sort > tbody > tr:nth-child(5) > td:nth-child(19)").append(`<span id='idtdybpl'><br /><b style="background: pink;">${tdybpl}</b></span>`);

        jQ('#idtotalbpl').remove();
        jQ("#sort > tbody > tr:nth-child(5) > td:nth-child(20)").append(`<span id='idtotalbpl'><br /><b style="background: pink;">${totalbpl}</b></span>`);
